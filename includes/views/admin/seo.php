<div class="row g-4">
    <div class="col-lg-3">
        <div class="admin-card p-0">
            <div class="list-group list-group-flush">
                ...
                <a href="<?= adminUrl('page=seo&edit=' . e($page['page_key'])) ?>" class="list-group-item list-group-item-action <?= $editKey === $page['page_key'] ? 'active' : '' ?>">
    ...
    <div class="col-lg-9">
        <div class="admin-card">
            <form method="POST" action="<?= adminUrl('page=seo&action=save') ?>">
                <?= csrfField() ?>
