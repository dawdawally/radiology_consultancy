<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= url('admin/?page=services&action=create') ?>" class="btn btn-primary"><i class="fa-solid fa-plus me-1"></i>Add Service</a>
</div>
        ...
        <table class="table table-hover mb-0">
            ...
            <tr>
                ...
                <td class="text-end">
                    ...
                    <a href="<?= url('admin/?page=services&action=edit&id=' . $s['id']) ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                    <a href="<?= url('admin/?page=services&action=delete&id=' . $s['id'] . '&csrf_token=' . csrfToken()) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this service?')">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
            </tbody>
